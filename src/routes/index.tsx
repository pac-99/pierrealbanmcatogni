    ...
    <div className="mx-auto max-w-6xl px-6">
      ...
      <Section title="Education">
        ...
        <ul className="mt-4 space-y-2 text-[15px] leading-relaxed text-foreground/80">
          <li className="pl-5 relative"><span className="absolute left-0 top-[0.7em] w-2 h-px bg-muted-foreground/60" />Coursework: Data Analysis and Statistics, Economics of Strategy, Advanced Competitive Strategy, Corporate Strategy, Product Management, Global Negotiations, Financial Modeling.</li>
