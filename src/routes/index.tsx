...
const competencies = [
  ...
  },
  {
    ...
    items: ["Driven", "Curious", "Deliberate", "Deep Learner", "Problem-Solver", "Adaptable", "Organized", "Analytical", "Team Player", "Creative", "Detail-Oriented", "Comfortable with Ambiguity", "Innovative Mindset"],
  },
];
