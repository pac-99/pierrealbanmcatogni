      ...
      <section className="pt-24 pb-20 md:pt-36 md:pb-28 grid grid-cols-12 gap-8 items-end">
        <div className="col-span-12 md:col-span-8">
          ...
          <div className="mt-10 flex flex-wrap gap-x-8 gap-y-2 text-sm text-muted-foreground">
            ...
            <a href="https://www.linkedin.com/in/pierre-alban-catogni" target="_blank" rel="noreferrer" className="hover:text-foreground transition-colors">linkedin.com/in/pierre-alban-catogni</a>
          </div>
        </div>
